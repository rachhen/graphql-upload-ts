...
const processRequest: ProcessRequestFunction = (
  request,
  response,
  {
  ...
  return new Promise((resolve, reject) => {
    ...
    let operations: ProcessRequestResult;

    let operationsPath: ObjectPathBound<ProcessRequestResult>;
     ...
     * @param [isParserError] Is the error from the parser.
     */
